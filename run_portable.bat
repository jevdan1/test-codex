...
rem Optional interactive pausing (set PORTABLE_INTERACTIVE=0 to disable keypresses)
set PORTABLE_INTERACTIVE=%PORTABLE_INTERACTIVE%
if "%PORTABLE_INTERACTIVE%"=="" set PORTABLE_INTERACTIVE=1
...
if /I "%PORTABLE_INTERACTIVE%"=="false" set PORTABLE_INTERACTIVE=0
if /I "%PORTABLE_INTERACTIVE%"=="auto" set PORTABLE_INTERACTIVE=0
if /I "%PORTABLE_INTERACTIVE%"=="no" set PORTABLE_INTERACTIVE=0
if /I "%PORTABLE_INTERACTIVE%"=="off" set PORTABLE_INTERACTIVE=0
if not "%PORTABLE_INTERACTIVE%"=="0" if not "%PORTABLE_INTERACTIVE%"=="1" set PORTABLE_INTERACTIVE=1
